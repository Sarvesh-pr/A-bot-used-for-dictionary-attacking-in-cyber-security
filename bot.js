...
async function login(page, text, username) {
    ...
    try {
        // console.log("here1")
        await page.waitForSelector("input[class='_aa4b _add6 _ac4d _ap35']");
    } catch (er) {
        found = true;
        // console.log("here2")
    ...
    if (!found) {
        ...
        await page.type("input[class='_aa4b _add6 _ac4d _ap35']", username);
        // console.log("here4")
        ...
        await page.waitForSelector("button[class=' _acan _acap _acas _aj1- _ap30']");
        // console.log("here7")

        await buttonClick(page, ' _acan _acap _acas _aj1- _ap30');
        // console.log("here8")
